      ...
      <form action="{{URL::to('updateUser')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="text" name="phone" placeholder="Enter your number" value="{{$user->phone}}" required>
          </div>
          <div class="input-box">
          ...
          <div class="input-box">
            ...
            <input type="password" name="password_confirmation" placeholder="Confirm your password" value="{{$user->password_confirmation}}" required>
          </div>
          <div class="input-box">
            <span class="details">User Type</span>
            <select name="user_type" id="user_type" value="{{$user->user_type}}" required>
        ...
        <div class="button">
          <input type="submit" name="Registration" value="Save Changes"  >
